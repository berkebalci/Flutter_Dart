          ...
          Stack( //Stackin birde fit diye bir parametresi vardır.Normalde bu parametreinin
            //**değeri Stack.loose'dır.
              ...
              Positioned(
               ...
               bottom: 100,
               child: LayoutBuilder(
                 builder: (context, constraints) { //Bu parametrelerle app'in çalıştığı ekranın
                    //**özelliklerine ulaşabiliyoruz.
                   if (constraints.maxWidth > 450){
                       ...
                       return Row(
                          ...
                          children: [
                            Meyve(),
                            Align( //Eğer ekranın genişliği 450'den fazla ise bu özellikler çalışıyor.
      ...
      // Column is also a layout widget. It takes a list of children and
        ...
        children: <Widget>[
          ...
          Container(
            child: Align(
                alignment: Alignment.bottomRight
                ,child: Image.network("https://picsum.photos/100/200")),
          ) //Buradaki 100 genişlik 200 ise yüksekliktir.
        //Bu fonksiyonu cached_network_imaged yardımı ile kullandık.
          //Sunucu her hot reload'ta farklı bir resim göndermektedir.
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        /*Row(
        mainAxisAlignment: MainAxisAlignment.center, //Flexible ve
        children: [
            Expanded(
                child: Text("Merhaba")),
            Flexible(
  ...
  Widget build(BuildContext context) {
    return  Container(
      ...
      child: Padding(
          ...
          ,child: Image.asset("images/Sincap.jpg")), //Internetten indirmeden dosyadan aldığımız resim
    );
