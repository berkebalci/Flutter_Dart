...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Stack( //Stackin birde fit diye bir parametresi vardır.Normalde bu parametreinin
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Align(      //Bu layout widget'ı ile butonun ekrandaki konumunu değiştirdik.
        ...
        child: Center(
          child: SizedBox(
            ...
            child: Container(
              ...
              color: Colors.blue,
              child: Center( //Container'ın belli bir sınırda istediği alaı kapsaması için parent class yarattık.
                child: Container(
                  color: Colors.red,
                  child: Padding( //Padding widget'ı sardığı widegtın etrafına boşluk bırakır.
                    ...
                    child: Container(
                      ...
                      height: 100,
                      child: Center(
                          //Center widget'ı olmadan Text'in kapladığı alan SizedBox'un kapsadığı alandı
                          //**ama Center gelince sadece kendi kadar alan kaplamaya başladı.
                          //Çünkü SizedBox Center'ı geriyor Text'i değil(Container olmadan yani)
                          child: Text(
                        "Beybi",
                        textAlign: TextAlign.left, //Center widget'ı ile bunun bir anlamı yok.
                      )),
                    ),
                  ),
                ),
